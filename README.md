...
The unprefixed 0.x tool names remain registered as deprecated aliases for the
1.0 transition window. New clients should use the `tempest_*` names below to
avoid collisions in multi-server MCP sessions.
